...
We essentially have three choices for creating business processes today.

- Software development
- Managed Cloud Services
- 'Shadow IT' with Microsoft Excel

Whilst constantly improving - 'formal' software development is relatively slow, expensive and often inappropriate for new and experimental stuff. Managed cloud services are great until you need a feature developed or want to retain ownership of your data.
...
In this post we will be exploring a fourth option - teaching ‘The Business’ how to code. We can maintain independence by learning how to create lightweight powerful and safe programs in Python instead of using Excel or other desktop tools.
